	soc_system u0 (
		...
		.video_dma_0_avalon_streaming_source_data          (<connected-to-video_dma_0_avalon_streaming_source_data>),          // video_dma_0_avalon_streaming_source.data
		.video_dma_0_avalon_streaming_source_endofpacket   (<connected-to-video_dma_0_avalon_streaming_source_endofpacket>),   //                                    .endofpacket
		.video_dma_0_avalon_streaming_source_ready         (<connected-to-video_dma_0_avalon_streaming_source_ready>),         //                                    .ready
		.video_dma_0_avalon_streaming_source_startofpacket (<connected-to-video_dma_0_avalon_streaming_source_startofpacket>), //                                    .startofpacket
		.video_dma_0_avalon_streaming_source_valid         (<connected-to-video_dma_0_avalon_streaming_source_valid>)          //                                    .valid
	);
