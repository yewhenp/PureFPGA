...
module soc_system_mm_interconnect_4 (
		...
		output wire [12:0] video_buffer_s1_address,                                //                                  video_buffer_s1.address
		output wire        video_buffer_s1_write,                                  //                                                 .write
		input  wire [31:0] video_buffer_s1_readdata,                               //                                                 .readdata
		output wire [31:0] video_buffer_s1_writedata,                              //                                                 .writedata
		output wire [3:0]  video_buffer_s1_byteenable,                             //                                                 .byteenable
		output wire        video_buffer_s1_chipselect,                             //                                                 .chipselect
		output wire        video_buffer_s1_clken,                                  //                                                 .clken
	...
	wire   [1:0] cmd_mux_src_channel;                                                     // cmd_mux:src_channel -> videocard_new_0_memory_main_agent:cp_channel
	...
	wire  [31:0] video_buffer_s1_agent_m0_readdata;                                       // video_buffer_s1_translator:uav_readdata -> video_buffer_s1_agent:m0_readdata
	wire         video_buffer_s1_agent_m0_waitrequest;                                    // video_buffer_s1_translator:uav_waitrequest -> video_buffer_s1_agent:m0_waitrequest
	wire         video_buffer_s1_agent_m0_debugaccess;                                    // video_buffer_s1_agent:m0_debugaccess -> video_buffer_s1_translator:uav_debugaccess
	wire  [19:0] video_buffer_s1_agent_m0_address;                                        // video_buffer_s1_agent:m0_address -> video_buffer_s1_translator:uav_address
	wire   [3:0] video_buffer_s1_agent_m0_byteenable;                                     // video_buffer_s1_agent:m0_byteenable -> video_buffer_s1_translator:uav_byteenable
	wire         video_buffer_s1_agent_m0_read;                                           // video_buffer_s1_agent:m0_read -> video_buffer_s1_translator:uav_read
	wire         video_buffer_s1_agent_m0_readdatavalid;                                  // video_buffer_s1_translator:uav_readdatavalid -> video_buffer_s1_agent:m0_readdatavalid
	wire         video_buffer_s1_agent_m0_lock;                                           // video_buffer_s1_agent:m0_lock -> video_buffer_s1_translator:uav_lock
	wire  [31:0] video_buffer_s1_agent_m0_writedata;                                      // video_buffer_s1_agent:m0_writedata -> video_buffer_s1_translator:uav_writedata
	wire         video_buffer_s1_agent_m0_write;                                          // video_buffer_s1_agent:m0_write -> video_buffer_s1_translator:uav_write
	wire   [2:0] video_buffer_s1_agent_m0_burstcount;                                     // video_buffer_s1_agent:m0_burstcount -> video_buffer_s1_translator:uav_burstcount
	wire         video_buffer_s1_agent_rf_source_valid;                                   // video_buffer_s1_agent:rf_source_valid -> video_buffer_s1_agent_rsp_fifo:in_valid
	wire  [90:0] video_buffer_s1_agent_rf_source_data;                                    // video_buffer_s1_agent:rf_source_data -> video_buffer_s1_agent_rsp_fifo:in_data
	wire         video_buffer_s1_agent_rf_source_ready;                                   // video_buffer_s1_agent_rsp_fifo:in_ready -> video_buffer_s1_agent:rf_source_ready
	wire         video_buffer_s1_agent_rf_source_startofpacket;                           // video_buffer_s1_agent:rf_source_startofpacket -> video_buffer_s1_agent_rsp_fifo:in_startofpacket
	wire         video_buffer_s1_agent_rf_source_endofpacket;                             // video_buffer_s1_agent:rf_source_endofpacket -> video_buffer_s1_agent_rsp_fifo:in_endofpacket
	wire         video_buffer_s1_agent_rsp_fifo_out_valid;                                // video_buffer_s1_agent_rsp_fifo:out_valid -> video_buffer_s1_agent:rf_sink_valid
	wire  [90:0] video_buffer_s1_agent_rsp_fifo_out_data;                                 // video_buffer_s1_agent_rsp_fifo:out_data -> video_buffer_s1_agent:rf_sink_data
	wire         video_buffer_s1_agent_rsp_fifo_out_ready;                                // video_buffer_s1_agent:rf_sink_ready -> video_buffer_s1_agent_rsp_fifo:out_ready
	wire         video_buffer_s1_agent_rsp_fifo_out_startofpacket;                        // video_buffer_s1_agent_rsp_fifo:out_startofpacket -> video_buffer_s1_agent:rf_sink_startofpacket
	wire         video_buffer_s1_agent_rsp_fifo_out_endofpacket;                          // video_buffer_s1_agent_rsp_fifo:out_endofpacket -> video_buffer_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_001_src_valid;                                                   // cmd_mux_001:src_valid -> video_buffer_s1_agent:cp_valid
	wire  [89:0] cmd_mux_001_src_data;                                                    // cmd_mux_001:src_data -> video_buffer_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                   // video_buffer_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                                 // cmd_mux_001:src_channel -> video_buffer_s1_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                           // cmd_mux_001:src_startofpacket -> video_buffer_s1_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                             // cmd_mux_001:src_endofpacket -> video_buffer_s1_agent:cp_endofpacket
	...
	wire         video_buffer_s1_agent_rp_valid;                                          // video_buffer_s1_agent:rp_valid -> router_002:sink_valid
	wire  [89:0] video_buffer_s1_agent_rp_data;                                           // video_buffer_s1_agent:rp_data -> router_002:sink_data
	wire         video_buffer_s1_agent_rp_ready;                                          // router_002:sink_ready -> video_buffer_s1_agent:rp_ready
	wire         video_buffer_s1_agent_rp_startofpacket;                                  // video_buffer_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         video_buffer_s1_agent_rp_endofpacket;                                    // video_buffer_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire         router_src_valid;                                                        // router:src_valid -> axi_master_bridge_m0_limiter:cmd_sink_valid
	wire  [89:0] router_src_data;                                                         // router:src_data -> axi_master_bridge_m0_limiter:cmd_sink_data
	wire         router_src_ready;                                                        // axi_master_bridge_m0_limiter:cmd_sink_ready -> router:src_ready
	wire   [1:0] router_src_channel;                                                      // router:src_channel -> axi_master_bridge_m0_limiter:cmd_sink_channel
	wire         router_src_startofpacket;                                                // router:src_startofpacket -> axi_master_bridge_m0_limiter:cmd_sink_startofpacket
	wire         router_src_endofpacket;                                                  // router:src_endofpacket -> axi_master_bridge_m0_limiter:cmd_sink_endofpacket
	wire  [89:0] axi_master_bridge_m0_limiter_cmd_src_data;                               // axi_master_bridge_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         axi_master_bridge_m0_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> axi_master_bridge_m0_limiter:cmd_src_ready
	wire   [1:0] axi_master_bridge_m0_limiter_cmd_src_channel;                            // axi_master_bridge_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire         axi_master_bridge_m0_limiter_cmd_src_startofpacket;                      // axi_master_bridge_m0_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire         axi_master_bridge_m0_limiter_cmd_src_endofpacket;                        // axi_master_bridge_m0_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire         rsp_mux_src_valid;                                                       // rsp_mux:src_valid -> axi_master_bridge_m0_limiter:rsp_sink_valid
	wire  [89:0] rsp_mux_src_data;                                                        // rsp_mux:src_data -> axi_master_bridge_m0_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                       // axi_master_bridge_m0_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [1:0] rsp_mux_src_channel;                                                     // rsp_mux:src_channel -> axi_master_bridge_m0_limiter:rsp_sink_channel
	wire         rsp_mux_src_startofpacket;                                               // rsp_mux:src_startofpacket -> axi_master_bridge_m0_limiter:rsp_sink_startofpacket
	wire         rsp_mux_src_endofpacket;                                                 // rsp_mux:src_endofpacket -> axi_master_bridge_m0_limiter:rsp_sink_endofpacket
	wire         axi_master_bridge_m0_limiter_rsp_src_valid;                              // axi_master_bridge_m0_limiter:rsp_src_valid -> axi_master_bridge_m0_agent:rp_valid
	wire  [89:0] axi_master_bridge_m0_limiter_rsp_src_data;                               // axi_master_bridge_m0_limiter:rsp_src_data -> axi_master_bridge_m0_agent:rp_data
	wire         axi_master_bridge_m0_limiter_rsp_src_ready;                              // axi_master_bridge_m0_agent:rp_ready -> axi_master_bridge_m0_limiter:rsp_src_ready
	wire   [1:0] axi_master_bridge_m0_limiter_rsp_src_channel;                            // axi_master_bridge_m0_limiter:rsp_src_channel -> axi_master_bridge_m0_agent:rp_channel
	wire         axi_master_bridge_m0_limiter_rsp_src_startofpacket;                      // axi_master_bridge_m0_limiter:rsp_src_startofpacket -> axi_master_bridge_m0_agent:rp_startofpacket
	wire         axi_master_bridge_m0_limiter_rsp_src_endofpacket;                        // axi_master_bridge_m0_limiter:rsp_src_endofpacket -> axi_master_bridge_m0_agent:rp_endofpacket
	...
	wire   [1:0] axi_master_bridge_m0_limiter_cmd_valid_data;                             // axi_master_bridge_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	wire         video_buffer_s1_agent_rdata_fifo_src_valid;                              // video_buffer_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] video_buffer_s1_agent_rdata_fifo_src_data;                               // video_buffer_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         video_buffer_s1_agent_rdata_fifo_src_ready;                              // avalon_st_adapter_001:in_0_ready -> video_buffer_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                       // avalon_st_adapter_001:out_0_valid -> video_buffer_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                        // avalon_st_adapter_001:out_0_data -> video_buffer_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                       // video_buffer_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                       // avalon_st_adapter_001:out_0_error -> video_buffer_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) video_buffer_s1_translator (
		.clk                    (pll_0_outclk3_clk),                                   //                      clk.clk
		.reset                  (axi_master_bridge_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (video_buffer_s1_agent_m0_address),                    // avalon_universal_slave_0.address
		.uav_burstcount         (video_buffer_s1_agent_m0_burstcount),                 //                         .burstcount
		.uav_read               (video_buffer_s1_agent_m0_read),                       //                         .read
		.uav_write              (video_buffer_s1_agent_m0_write),                      //                         .write
		.uav_waitrequest        (video_buffer_s1_agent_m0_waitrequest),                //                         .waitrequest
		.uav_readdatavalid      (video_buffer_s1_agent_m0_readdatavalid),              //                         .readdatavalid
		.uav_byteenable         (video_buffer_s1_agent_m0_byteenable),                 //                         .byteenable
		.uav_readdata           (video_buffer_s1_agent_m0_readdata),                   //                         .readdata
		.uav_writedata          (video_buffer_s1_agent_m0_writedata),                  //                         .writedata
		.uav_lock               (video_buffer_s1_agent_m0_lock),                       //                         .lock
		.uav_debugaccess        (video_buffer_s1_agent_m0_debugaccess),                //                         .debugaccess
		.av_address             (video_buffer_s1_address),                             //      avalon_anti_slave_0.address
		.av_write               (video_buffer_s1_write),                               //                         .write
		.av_readdata            (video_buffer_s1_readdata),                            //                         .readdata
		.av_writedata           (video_buffer_s1_writedata),                           //                         .writedata
		.av_byteenable          (video_buffer_s1_byteenable),                          //                         .byteenable
		.av_chipselect          (video_buffer_s1_chipselect),                          //                         .chipselect
		.av_clken               (video_buffer_s1_clken),                               //                         .clken
		.av_read                (),                                                    //              (terminated)
		.av_begintransfer       (),                                                    //              (terminated)
		.av_beginbursttransfer  (),                                                    //              (terminated)
		.av_burstcount          (),                                                    //              (terminated)
	...
	altera_merlin_master_agent #(
		...
		.rp_valid              (axi_master_bridge_m0_limiter_rsp_src_valid),                              //        rp.valid
		.rp_data               (axi_master_bridge_m0_limiter_rsp_src_data),                               //          .data
		.rp_channel            (axi_master_bridge_m0_limiter_rsp_src_channel),                            //          .channel
		.rp_startofpacket      (axi_master_bridge_m0_limiter_rsp_src_startofpacket),                      //          .startofpacket
		.rp_endofpacket        (axi_master_bridge_m0_limiter_rsp_src_endofpacket),                        //          .endofpacket
		.rp_ready              (axi_master_bridge_m0_limiter_rsp_src_ready),                              //          .ready
		.av_response           (),                                                                        // (terminated)
		.av_writeresponsevalid ()                                                                         // (terminated)
	);
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) video_buffer_s1_agent (
		.clk                     (pll_0_outclk3_clk),                                   //             clk.clk
		.reset                   (axi_master_bridge_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (video_buffer_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (video_buffer_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (video_buffer_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (video_buffer_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (video_buffer_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (video_buffer_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (video_buffer_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (video_buffer_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (video_buffer_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (video_buffer_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (video_buffer_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (video_buffer_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (video_buffer_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (video_buffer_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (video_buffer_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (video_buffer_s1_agent_rp_startofpacket),              //                .startofpacket
		...
		.rf_sink_ready           (video_buffer_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (video_buffer_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (video_buffer_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (video_buffer_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (video_buffer_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (video_buffer_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (video_buffer_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (video_buffer_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (video_buffer_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (video_buffer_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (video_buffer_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (video_buffer_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (video_buffer_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) video_buffer_s1_agent_rsp_fifo (
		.clk               (pll_0_outclk3_clk),                                   //       clk.clk
		.reset             (axi_master_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (video_buffer_s1_agent_rf_source_data),                //        in.data
		.in_valid          (video_buffer_s1_agent_rf_source_valid),               //          .valid
		.in_ready          (video_buffer_s1_agent_rf_source_ready),               //          .ready
		.in_startofpacket  (video_buffer_s1_agent_rf_source_startofpacket),       //          .startofpacket
		.in_endofpacket    (video_buffer_s1_agent_rf_source_endofpacket),         //          .endofpacket
		.out_data          (video_buffer_s1_agent_rsp_fifo_out_data),             //       out.data
		.out_valid         (video_buffer_s1_agent_rsp_fifo_out_valid),            //          .valid
		.out_ready         (video_buffer_s1_agent_rsp_fifo_out_ready),            //          .ready
		.out_startofpacket (video_buffer_s1_agent_rsp_fifo_out_startofpacket),    //          .startofpacket
		.out_endofpacket   (video_buffer_s1_agent_rsp_fifo_out_endofpacket),      //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	soc_system_mm_interconnect_4_router_001 router_002 (
		.sink_ready         (video_buffer_s1_agent_rp_ready),                      //      sink.ready
		.sink_valid         (video_buffer_s1_agent_rp_valid),                      //          .valid
		.sink_data          (video_buffer_s1_agent_rp_data),                       //          .data
		.sink_startofpacket (video_buffer_s1_agent_rp_startofpacket),              //          .startofpacket
		.sink_endofpacket   (video_buffer_s1_agent_rp_endofpacket),                //          .endofpacket
		.clk                (pll_0_outclk3_clk),                                   //       clk.clk
		.reset              (axi_master_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_traffic_limiter #(
		...
		.cmd_src_ready          (axi_master_bridge_m0_limiter_cmd_src_ready),          //   cmd_src.ready
		.cmd_src_data           (axi_master_bridge_m0_limiter_cmd_src_data),           //          .data
		.cmd_src_channel        (axi_master_bridge_m0_limiter_cmd_src_channel),        //          .channel
		.cmd_src_startofpacket  (axi_master_bridge_m0_limiter_cmd_src_startofpacket),  //          .startofpacket
		.cmd_src_endofpacket    (axi_master_bridge_m0_limiter_cmd_src_endofpacket),    //          .endofpacket
		...
		.rsp_src_ready          (axi_master_bridge_m0_limiter_rsp_src_ready),          //   rsp_src.ready
		.rsp_src_valid          (axi_master_bridge_m0_limiter_rsp_src_valid),          //          .valid
		.rsp_src_data           (axi_master_bridge_m0_limiter_rsp_src_data),           //          .data
		.rsp_src_channel        (axi_master_bridge_m0_limiter_rsp_src_channel),        //          .channel
		.rsp_src_startofpacket  (axi_master_bridge_m0_limiter_rsp_src_startofpacket),  //          .startofpacket
		.rsp_src_endofpacket    (axi_master_bridge_m0_limiter_rsp_src_endofpacket),    //          .endofpacket
		.cmd_src_valid          (axi_master_bridge_m0_limiter_cmd_valid_data)          // cmd_valid.data
	);

	soc_system_mm_interconnect_4_cmd_demux cmd_demux (
		.clk                (pll_0_outclk3_clk),                                   //        clk.clk
		.reset              (axi_master_bridge_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
		.sink_ready         (axi_master_bridge_m0_limiter_cmd_src_ready),          //       sink.ready
		.sink_channel       (axi_master_bridge_m0_limiter_cmd_src_channel),        //           .channel
		.sink_data          (axi_master_bridge_m0_limiter_cmd_src_data),           //           .data
		.sink_startofpacket (axi_master_bridge_m0_limiter_cmd_src_startofpacket),  //           .startofpacket
		.sink_endofpacket   (axi_master_bridge_m0_limiter_cmd_src_endofpacket),    //           .endofpacket
		.sink_valid         (axi_master_bridge_m0_limiter_cmd_valid_data),         // sink_valid.data
	...
	soc_system_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_0_data      (video_buffer_s1_agent_rdata_fifo_src_data),           //     in_0.data
		.in_0_valid     (video_buffer_s1_agent_rdata_fifo_src_valid),          //         .valid
		.in_0_ready     (video_buffer_s1_agent_rdata_fifo_src_ready),          //         .ready
