	soc_system u0 (
		...
		.alt_vip_cl_cvo_0_din_data                                 (<connected-to-alt_vip_cl_cvo_0_din_data>),                                 //                        alt_vip_cl_cvo_0_din.data
		.alt_vip_cl_cvo_0_din_valid                                (<connected-to-alt_vip_cl_cvo_0_din_valid>),                                //                                            .valid
		.alt_vip_cl_cvo_0_din_startofpacket                        (<connected-to-alt_vip_cl_cvo_0_din_startofpacket>),                        //                                            .startofpacket
		.alt_vip_cl_cvo_0_din_endofpacket                          (<connected-to-alt_vip_cl_cvo_0_din_endofpacket>),                          //                                            .endofpacket
		.alt_vip_cl_cvo_0_din_ready                                (<connected-to-alt_vip_cl_cvo_0_din_ready>),                                //                                            .ready
		...
		.our_video_dma_0_video_data_streaming_source_data          (<connected-to-our_video_dma_0_video_data_streaming_source_data>),          // our_video_dma_0_video_data_streaming_source.data
		.our_video_dma_0_video_data_streaming_source_endofpacket   (<connected-to-our_video_dma_0_video_data_streaming_source_endofpacket>),   //                                            .endofpacket
		.our_video_dma_0_video_data_streaming_source_ready         (<connected-to-our_video_dma_0_video_data_streaming_source_ready>),         //                                            .ready
		.our_video_dma_0_video_data_streaming_source_startofpacket (<connected-to-our_video_dma_0_video_data_streaming_source_startofpacket>), //                                            .startofpacket
		.our_video_dma_0_video_data_streaming_source_valid         (<connected-to-our_video_dma_0_video_data_streaming_source_valid>),         //                                            .valid
