...
module soc_system_mm_interconnect_0 (
		...
		input  wire [31:0] ARM_A9_HPS_h2f_axi_master_wdata,                                       //                                                                .wdata
		input  wire [3:0]  ARM_A9_HPS_h2f_axi_master_wstrb,                                       //                                                                .wstrb
		...
		output wire [31:0] ARM_A9_HPS_h2f_axi_master_rdata,                                       //                                                                .rdata
		...
		output wire [2:0]  onchip_memory2_0_s1_address,                                           //                                             onchip_memory2_0_s1.address
	...
	wire  [120:0] rsp_mux_src_data;                                        // rsp_mux:src_data -> ARM_A9_HPS_h2f_axi_master_agent:write_rp_data
	...
	wire  [120:0] rsp_mux_001_src_data;                                    // rsp_mux_001:src_data -> ARM_A9_HPS_h2f_axi_master_agent:read_rp_data
	...
	wire  [120:0] arm_a9_hps_h2f_axi_master_agent_write_cp_data;           // ARM_A9_HPS_h2f_axi_master_agent:write_cp_data -> router:sink_data
	...
	wire  [120:0] arm_a9_hps_h2f_axi_master_agent_read_cp_data;            // ARM_A9_HPS_h2f_axi_master_agent:read_cp_data -> router_001:sink_data
	...
	wire  [120:0] onchip_memory2_0_s1_agent_rp_data;                       // onchip_memory2_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [120:0] cmd_mux_src_data;                                        // cmd_mux:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
